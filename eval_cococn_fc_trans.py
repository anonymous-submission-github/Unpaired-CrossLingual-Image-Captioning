...
import eval_utils_cn_fc as eval_utils
# import eval_utils_en_fc as eval_utils
# import eval_utils_fc as eval_utils
import argparse
...
parser.add_argument('--use_ssg', type=int, default=0, help='If use ssg')
...
# image scene graph test
opt.input_ssg_dir='data/coco_cn/coco_COCOCN_pred_fuse_sg_v3_newid_small_en'
opt.caption_model='newfc'
opt.split='test'

opt.start_from='unpaired_image_caption_revise/save/20201117_152525_newfc/'
opt.checkpoint_path='unpaired_image_caption_revise/save/20201117_152525_newfc/'
opt.model= 'unpaired_image_caption_revise/save/20201117_152525_newfc/model-best.pth'
opt.infos_path='unpaired_image_caption_revise/save/20201117_152525_newfc/infos-best.pkl'
...
ignore = [ 'checkpoint_path',"use_gfc", "use_isg", "ssg_dict_path", "input_json", "input_label_h5", "id", "batch_size", "start_from", "language_eval", "use_rela", "input_ssg_dir", "ssg_dict_path", "input_rela_dir", "use_spectral_norm", "beam_size",'gpu','caption_model']
...
if getattr(opt, 'use_isg', 0) == 1:
    ...
    loss, split_predictions, lang_stats = eval_utils.eval_split_fc(model, crit, loader, vars(opt))
