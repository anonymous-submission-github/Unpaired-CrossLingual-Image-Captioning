...
def language_eval(dataset, preds, model_id, split):
    ...
    # annFile = 'data/AIC_mt_cocostyle_val_test_en.json'
    # annFile='data/aic_process/ALL_11683_v2_COCOCN_val_test_en.json'
    # annFile='data/aic_process/ALL_11683_v3_COCOCN_val_test_en.json'
    annFile='data/aic_process/COCOCN_val_test_en_6sens.json'
