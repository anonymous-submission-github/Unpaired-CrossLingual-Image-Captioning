...
parser.add_argument('--model', type=str, default='unpaired_image_caption_revise/save/20200316_203131_gtssg_sep_self_att_sep_v2/model.pth', help='path to model to evaluate')
...
parser.add_argument('--infos_path', type=str, default='unpaired_image_caption_revise/save/20200316_203131_gtssg_sep_self_att_sep_v2/infos.pkl', help='path to infos to evaluate')
# Basic options
...
parser.add_argument('--input_json', type=str, default='data/aic_process/cocobu_ALL_11683_COCOCN_t5.json', help='path to the json file containing additional info and vocab. empty = fetch from model checkpoint.')
...
# spice scene graph test
opt.input_ssg_dir='data/aic_process/ALL_11683_v3_COCOCN_spice_sg_t5_en_dict2_aug'
opt.input_json='data/aic_process/cocobu_ALL_11683_v3_COCOCN_t5_testtrans.json'
opt.input_label_h5='data/aic_process/cocobu_ALL_11683_v3_COCOCN_t5_label.h5'
...
ignore = ["caption_model", "use_gfc", "use_isg", "ssg_dict_path", "input_json", "input_label_h5", "id", "batch_size", "start_from", "language_eval", "use_rela", "input_ssg_dir", "--ssg_dict_path", "input_rela_dir", "use_spectral_norm", "beam_size"]
