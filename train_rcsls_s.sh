...
{
    python train_paired_mt_RCSLS_submap.py --caption_model gtssg_sep_self_att_sep_vv1_RCSLS_submap_v2 --batch_size 50 --accumulate_number 2 --use_ssg 1 --use_isg 0 --freeze_i2t 0 --use_batch_norm 0 \
                    ...
                    --learning_rate 5e-5 --learning_rate_decay_start 0 --scheduled_sampling_start 0 --learning_rate_decay_every 5 \
                    --save_checkpoint_every 500 --language_eval 1 --beam_size 5 --val_images_use 1000 --max_epochs 80 \
