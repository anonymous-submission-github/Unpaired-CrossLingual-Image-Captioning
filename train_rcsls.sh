...
{
    python train_paired_mt_RCSLS.py --caption_model gtssg_sep_self_att_sep_vv1_RCSLS --batch_size 50 --accumulate_number 2 --use_ssg 1 --use_isg 0 --freeze_i2t 0 --use_batch_norm 0 \
...
# with data_aug
func_train_sepself_att_sep_v2_b50_en()
{
    python train_paired_mt_en_RCSLS.py --caption_model gtssg_sep_self_att_sep_vv1_RCSLS_en --batch_size 50 --accumulate_number 2 --use_ssg 1 --use_isg 0 --freeze_i2t 0 --use_batch_norm 0 \
                    --input_fc_dir data/cocobu_fc --input_att_dir data/cocobu_att --input_ssg_dir data/aic_process/ALL_11683_v3_COCOCN_spice_sg_t5_en_dict2_aug \
                    ...
                    --learning_rate 5e-5 --learning_rate_decay_start -1 --scheduled_sampling_start 0 --learning_rate_decay_every 5 \
                    --save_checkpoint_every 1000 --language_eval 1 --beam_size 5 --val_images_use 1000 --max_epochs 80 \
                    --checkpoint_path save  --train_split train --gpu 1 --self_critical_after 100000 --seq_per_img 1 --p_flag 1
}
