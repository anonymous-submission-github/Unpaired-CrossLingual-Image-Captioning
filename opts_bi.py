...
def parse_opt():
    ...
    parser.add_argument('--use_paired_ssg', type=int, default=0, help='')
    parser.add_argument('--init_path_en', type=str, default='', help='path to initialize the model for joint training')
    parser.add_argument('--init_path_zh', type=str, default='', help='path to initialize the model for joint training')

    parser.add_argument('--input_json', type=str, default='data/aic_process/cocobu_ALL_11683_COCOCN_t5.json', help='path to the json file containing additional info and vocab')
    parser.add_argument('--input_json_en', type=str, default='', help='path to the json file containing additional info and vocab')
    parser.add_argument('--input_coco_json', type=str, default='data/aic_process/cocobu_ALL_11683_COCOCN_t5.json', help='path to the json file containing additional info and vocab')
    ...
    parser.add_argument('--input_ssg_dir', type=str, default='data/aic_process/ALL_11683_COCOCN_spice_sg_t5', help='path to the directory containing the ground truth sentence scene graph')
    parser.add_argument('--input_ssg_dir_en', type=str, default='', help='path to the directory containing the ground truth sentence scene graph')
    parser.add_argument('--input_label_h5', type=str, default='data/aic_process/cocobu_ALL_11683_COCOCN_t5_label.h5', help='path to the h5file containing the preprocessed dataset')
    parser.add_argument('--input_label_h5_en', type=str, default='', help='path to the h5file containing the preprocessed dataset')
    parser.add_argument('--input_coco_label_h5', type=str, default='data/aic_process/cocobu_ALL_11683_COCOCN_t5_label.h5', help='path to the h5file containing the preprocessed dataset')
    ...
    parser.add_argument('--start_from', type=str, default=None,
                    ...
                    """)
    parser.add_argument('--start_from_en', type=str, default=None,
                        help="""continue training from saved model at this path. Path must contain files saved by previous training process: 
                        'infos.pkl'         : configuration;
                        'checkpoint'        : paths to model file(s) (created by tf).
                                              Note: this file contains absolute paths, be careful when moving files around;
    ...
    parser.add_argument('--caption_model_en', type=str, default="gtssg_sep_self_att_sep_v2", help='show_tell, show_attend_tell, all_img, fc, att2in, att2in2, att2all2, adaatt, adaattmo, topdown, stackatt, denseatt, gtssg, gtssg_up')
    parser.add_argument('--caption_model_zh', type=str, default="gtssg_sep_self_att_sep_v2", help='show_tell, show_attend_tell, all_img, fc, att2in, att2in2, att2all2, adaatt, adaattmo, topdown, stackatt, denseatt, gtssg, gtssg_up')
    ...
    parser.add_argument('--freeze_i2t', type=int, default=0, help='If freeze i2t')
    ...
    parser.add_argument('--ssg_dict_path', type=str, default='data/aic_process/ALL_11683_COCOCN_spice_sg_dict_t5.npz_revise.npz', help='path to the sentence scene graph directory')
    parser.add_argument('--ssg_dict_path_en', type=str, default='', help='path to the sentence scene graph directory')
    ...
    parser.add_argument('--batch_size', type=int, default=150, help='minibatch size')
    ...
    parser.add_argument('--learning_rate_decay_every', type=int, default=5, help='every how many iterations thereafter to drop LR?(in epoch)')
