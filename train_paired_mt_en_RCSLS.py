...
import eval_utils_en_simple as eval_utils
...
def train(opt):
    ...
    infos = {}
    histories = {}
    if opt.start_from_en is not None:
    ...
    while True:
        ...
        # if (iteration % 100 == 0) and (iteration != 0):
            ...
            val_loss, predictions, lang_stats = eval_utils.eval_split(dp_model, crit, loader,opt.p_flag, eval_kwargs)
