...
def parse_opt():
    ...
    # Whether in joint training
    parser.add_argument('--p_flag', type=int, default=0, help='whether use joint training')

    # Data input settings
    parser.add_argument('--use_pretrained_setting', type=int, default='0', help='path to the json file containing additional info and vocab')
    parser.add_argument('--input_json', type=str, default='data/cocobu_aic_en_t1.json', help='path to the json file containing additional info and vocab')
    parser.add_argument('--input_coco_json', type=str, default='data/cocobu_aic_en_t1.json', help='path to the json file containing additional info and vocab')
    ...
    parser.add_argument('--input_ssg_dir', type=str, default='data/aic_mt_spice_sg_en_t1', help='path to the directory containing the ground truth sentence scene graph')
    parser.add_argument('--input_label_h5', type=str, default='data/cocobu_aic_en_t1_label.h5', help='path to the h5file containing the preprocessed dataset')
    parser.add_argument('--input_coco_label_h5', type=str, default='data/cocobu_aic_en_t1_label.h5', help='path to the h5file containing the preprocessed dataset')
    ...
    parser.add_argument('--ssg_dict_path', type=str, default='data/aic_mt_spice_sg_dict_en_t1.npz', help='path to the sentence scene graph directory')
    ...
    parser.add_argument('--checkpoint_path_p', type=str, default='save', help='directory to store checkpointed models')
