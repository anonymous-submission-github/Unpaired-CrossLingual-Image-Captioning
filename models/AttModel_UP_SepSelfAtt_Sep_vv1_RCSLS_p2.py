...
class AttModel(CaptionModel):
    ...
    def sg_gfc(self, sg_data, type):
        ...
        for img_id in range(N_img):
            ...
            obj_feats_ori = self.get_RCSLS_embed(sg_obj[img_id * seq_per_img, :N_obj])
            ...
            for obj_id in range(N_obj):
                ...
                if N_attr != 0:
                    ...
                    attr_feat_ori = self.get_RCSLS_embed(sg_attr[img_id * seq_per_img, obj_id, :N_attr])
...
class GTssgCore_UP_SepSelfAtt_SEP_vv1_RCSLS_p2(nn.Module):
    def __init__(self, opt, use_maxout=False):
        super(GTssgCore_UP_SepSelfAtt_SEP_vv1_RCSLS_p2, self).__init__()
        self.drop_prob_lm = opt.drop_prob_lm
...
class GTssgModel_UP_SepSelfAtt_SEP_vv1_RCSLS_p2(AttModel):
    def __init__(self, opt):
        super(GTssgModel_UP_SepSelfAtt_SEP_vv1_RCSLS_p2, self).__init__(opt)
        self.num_layers = 2
        self.core = GTssgCore_UP_SepSelfAtt_SEP_vv1_RCSLS_p2(opt)
