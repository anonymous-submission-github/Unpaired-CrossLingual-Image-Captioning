...
class GTssgCore_SepSelfAtt_SEP_vv1_RCSLS_submap_v2_add_wordmap_add_global_p2(nn.Module):
    def __init__(self, opt, use_maxout=False):
        super(GTssgCore_SepSelfAtt_SEP_vv1_RCSLS_submap_v2_add_wordmap_add_global_p2, self).__init__()
        self.drop_prob_lm = opt.drop_prob_lm
...
class GTssgModel_SepSelfAtt_SEP_vv1_RCSLS_submap_v2_add_wordmap_add_global_p2(AttModel):
    def __init__(self, opt):
        super(GTssgModel_SepSelfAtt_SEP_vv1_RCSLS_submap_v2_add_wordmap_add_global_p2, self).__init__(opt)
        self.num_layers = 2
        self.core = GTssgCore_SepSelfAtt_SEP_vv1_RCSLS_submap_v2_add_wordmap_add_global_p2(opt)
