...
class AttModel(CaptionModel):
    ...
    def ssg_gfc(self, ssg_data):
        ...
        for img_id in range(N_img):
            ...
            ssg_obj_feats[img_id * seq_per_img: (img_id + 1) * seq_per_img, :N_obj, :] = obj_feats_temp_zh
            if N_rela != 0:
...
class GTssgCore_SepSelfAtt_SEP_vv1_RCSLS_submap_v2(nn.Module):
    def __init__(self, opt, use_maxout=False):
        super(GTssgCore_SepSelfAtt_SEP_vv1_RCSLS_submap_v2, self).__init__()
        self.drop_prob_lm = opt.drop_prob_lm
...
class GTssgModel_SepSelfAtt_SEP_vv1_RCSLS_submap_v2(AttModel):
    def __init__(self, opt):
        super(GTssgModel_SepSelfAtt_SEP_vv1_RCSLS_submap_v2, self).__init__(opt)
        self.num_layers = 2
        self.core = GTssgCore_SepSelfAtt_SEP_vv1_RCSLS_submap_v2(opt)
