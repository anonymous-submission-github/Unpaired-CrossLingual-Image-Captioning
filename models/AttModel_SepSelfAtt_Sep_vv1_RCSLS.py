...
class GTssgCore_SepSelfAtt_SEP_vv1_RCSLS(nn.Module):
    def __init__(self, opt, use_maxout=False):
        super(GTssgCore_SepSelfAtt_SEP_vv1_RCSLS, self).__init__()
        self.drop_prob_lm = opt.drop_prob_lm
...
class GTssgModel_SepSelfAtt_SEP_vv1_RCSLS(AttModel):
    def __init__(self, opt):
        super(GTssgModel_SepSelfAtt_SEP_vv1_RCSLS, self).__init__(opt)
        self.num_layers = 2
        self.core = GTssgCore_SepSelfAtt_SEP_vv1_RCSLS(opt)
